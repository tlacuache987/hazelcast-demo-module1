...
public class CustomerServiceTest {
	...
	public void tearDown() {
		hazelcastInstance.getMap(MapNames.CUSTOMERS_MAP).clear();
	}
	...
	public void testAddCustomer() {
		...
		IMap<Long, Customer> customersMap = hazelcastInstance.getMap(MapNames.CUSTOMERS_MAP);
	...
	private List<Customer> generateCustomers(int maxCustomers) throws Exception {
		...
		for (long x = 0; x < maxCustomers; x++) {
			customers.add(new Customer(x // Customer ID
